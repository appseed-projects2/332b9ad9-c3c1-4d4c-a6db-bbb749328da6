...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-02 16:58`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/332b9ad9-c3c1-4d4c-a6db-bbb749328da6.git
$ cd 332b9ad9-c3c1-4d4c-a6db-bbb749328da6
```
